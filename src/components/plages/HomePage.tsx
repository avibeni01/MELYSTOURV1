            ...
            <div className="p-6">
              {activeTab === 'hotel' && (
                <div className="max-h-[800px] overflow-auto">
                  <p className="text-gray-600">Formulaire de réservation hôtel (composant temporairement indisponible)</p>
                </div>
              )}

              {activeTab === 'car' && (
                <div className="max-h-[800px] overflow-auto">
                  <p className="text-gray-600">Formulaire de location voiture (composant temporairement indisponible)</p>
                </div>
              )}
