...
import { beaches } from '@/data/deadSeaBeaches';
import { Beach, BeachType, BeachFacility } from '@/types/deadSeaBeach';
...
const DeadSeaBeachesSection: React.FC = () => {
  ...
  return (
    <section id="dead-sea-beaches" className="py-20 bg-blue-50">
