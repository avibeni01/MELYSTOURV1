...
import DeadSeaReligiousBeachCard from './DeadSeaReligiousBeachCard';
import { religiousBeaches } from '@/data/deadSeaBeaches';

const DeadSeaReligiousBeachesSection: React.FC = () => {
  return (
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {religiousBeaches.map((beach) => (
            <DeadSeaReligiousBeachCard key={beach.id} beach={beach} />
          ))}
        </div>
      </div>
    </section>
...
export default DeadSeaReligiousBeachesSection;
