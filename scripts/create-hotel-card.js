...
const hotelCardComponent = `'use client'
...
const filepath = path.join(__dirname, '..', 'src', 'components', 'hotels', 'HotelCard.tsx');
fs.writeFileSync(filepath, hotelCardComponent);
console.log('✓ HotelCard.tsx créé avec succès');
